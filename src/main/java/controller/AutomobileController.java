...
{
    @Inject
    IManageAutomobile automobileService;
    @Inject
    IManageClient clientService;
    @Inject
    ...
    void apply(ActionEvent event) {
            try {
                ...
                automobileService.editAutomobile(
                        new ManageAutomobileRequest(
                                automobile
                        ),
                        automobile.getId()
                );
    ...
    void archive(ActionEvent event) {
        ...
        try {
            automobileService.deleteAutomobile(currentAuto.getId());
            AlertInfo.getInstance().setTitle("Info");
            AlertInfo.getInstance().setHeaderText("Enregistrement automobile");
    ...
    void readAll() {
        ...
        this.allAutomobiles = automobileService.listAutomobile();
    ...
    void readClient(){
        this.allClients = clientService.listClient();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        client.setConverter(new StringConverter<Client>() {
            ...
            public Client fromString(String string) {
                ...
                return clientService.findClient(auto);
            }
        });
        ...
        autoTypeCompteur.getItems().setAll(Automobile.getCompteurs());
        selectTab(1);
