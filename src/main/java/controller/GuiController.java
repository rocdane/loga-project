...
public class GuiController implements Initializable
{
    ...
    void menu_admin(ActionEvent event) {
        if("ADMINISTRATEUR".equals(session.getUser().getRole())){
            setContent("/com/loga/client/fxml/admin.fxml");
            View.getInstance().getGui().setTitle("GMC PLUS | Administrateur");
            setNavigation("Administrateur");
        }else{
            throw new RuntimeException("Violation d'accès !!!");
        }
    }
    ...
    void menu_article(ActionEvent event) {
        if ("UTILISATEUR".equals(session.getUser().getRole())) {
            ...
            setContent("/com/loga/client/fxml/fourniture.fxml");
    ...
    void menu_atelier(ActionEvent event) {
        setContent("/com/loga/client/fxml/home-atelier.fxml");
    ...
    void menu_automobile(ActionEvent event) {
        setContent("/com/loga/client/fxml/automobile.fxml");
    ...
    void menu_client(ActionEvent event) {
        setContent("/com/loga/client/fxml/client.fxml");
    ...
    void menu_reception(ActionEvent event) {
        setContent("/com/loga/client/fxml/reception.fxml");
    ...
    void menu_reparation(ActionEvent event) {
        if ("UTILISATEUR".equals(session.getUser().getRole())) {
            ...
            setContent("/com/loga/client/fxml/reparation.fxml");
    ...
    void menu_atelier_agenda(ActionEvent event) {
        setContent("/com/loga/client/fxml/agenda.fxml");
    ...
    void menu_atelier_dossier(ActionEvent event) {
        setContent("/com/loga/client/fxml/dossier.fxml");
    ...
    void menu_atelier_profil(ActionEvent event) {
        if ("UTILISATEUR".equals(session.getUser().getRole())) {
            ...
            setContent("/com/loga/client/fxml/profile.fxml");
    ...
    void menu_atelier_stock(ActionEvent event) {
        if ("UTILISATEUR".equals(session.getUser().getRole())) {
            ...
            setContent("/com/loga/client/fxml/stock.fxml");
    ...
    void menu_atelier_tresor(ActionEvent event) {
        if ("UTILISATEUR".equals(session.getUser().getRole())) {
            ...
            setContent("/com/loga/client/fxml/tresor.fxml");
    ...
    void versHome(ActionEvent event) {
        setContent("/com/loga/client/fxml/home.fxml");
    ...
    void logout(ActionEvent event) {
        try {
            //TODO : Authenticate.logout(session);
            Parent auth = FXMLLoader.load((URL)Objects.requireNonNull(getClass().getResource("/fxml/auth-signin.fxml")));
